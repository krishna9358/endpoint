  ...
  return (
    <>
      <div className="flex items-center border-b border-zinc-800 bg-zinc-900 min-w-0">
        <div
          className="flex items-center flex-nowrap overflow-x-auto min-w-0 flex-1"
          style={{
            scrollbarWidth: "none",
        ...
        >
          ...
          {tabs.map((tab) => (
            <div
              ...
              className={`group shrink-0 h-10 px-4 flex items-center justify-between min-w-[160px] max-w-[220px] border-r border-zinc-800 cursor-pointer border-t-2 transition-colors ${
                activeTabId === tab.id
            ...
            >
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="flex items-center gap-2 overflow-hidden">
                  <p className="truncate font-semibold text-sm">{tab.title}</p>
                  {tab.unsavedChanges && (
